  ...
  <ul class="nav-menu">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="http://alove.great-site.net//joyofphp/joyphp/src/">Joy of PHP</a></li>
        <li><a href="http://alove.great-site.net//joyofphp/joyphp/src/samsusedcars.html">Sam's Used Cars</a></li>
